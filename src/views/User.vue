<template>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      <UserProfileCard :profile="profile" :isFollowed="isFollowed" />
      <div class="row">
        <div class="col-md-4">
...
export default {
  ...
  methods: {
    fetchData() {
      const userData = dummyData.profile;
      this.profile = {
        id: userData.id,
        name: userData.name,
        ...
        commentsAmount: userData.Comments.length,
        favRestsAmount: userData.FavoritedRestaurants.length,
        followersAmount: userData.Followers.length,
        followingsAmount: userData.Followings.length,
      };
      this.comments = userData.Comments;
      this.favoriteRestaurants = userData.FavoritedRestaurants;
      this.followers = userData.Followers;
      this.followings = userData.Followings;
